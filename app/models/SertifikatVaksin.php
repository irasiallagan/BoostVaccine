...
class SertifikatVaksin
{
    ...
    public function save()
    {
        ...
        // Pastikan VerificationStatus adalah integer
        $this->VerificationStatus = (int)(isset($this->VerificationStatus) && $this->VerificationStatus !== ''
            ? $this->VerificationStatus
            : 0); // Default ke 0 jika kosong atau null
