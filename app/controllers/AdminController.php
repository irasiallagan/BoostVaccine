...
class AdminController extends Controller
{
  ...
  //   $users = user::all(); // Pastikan model user sudah ada dan terdefinisi

  //   // Kirim data pengguna ke view 'admin/customers'
  //   $this->view('admin/customers', ['users' => $users]);

  //   // Cek jika ada permintaan untuk edit user
  //   if (isset($_GET['edit'])) {
  //     $_SESSION['id'] = $_GET['edit'];
  //     $this->edit_customer($_SESSION['id']); // Panggil metode edit_customer untuk edit data
  //   }
  // }

  public function customer()
  {
    // Mendapatkan semua pengguna dari model User
    $users = User::all_users();

    // Kirim data ke view 'admin/customers'
    $this->view('admin/customers', ['users' => $users]);
  }
  public function edit_customer($user_id, $new_data)
  {
    // Memperbarui data pengguna di database
    if (User::update_user($user_id, $new_data)) {
      // Redirect kembali ke halaman customers setelah berhasil edit
      header("Location: customers.php");
    } else {
      echo "Error: Gagal memperbarui data pengguna.";
    }
  }
  ...
  public function delete_customer($user_id)
  {
    ...
    if (User::delete_user($user_id)) {
      // Redirect kembali ke halaman customers setelah berhasil hapus
      header("Location: customers.php");
    } else {
      echo "Error: Gagal menghapus data pengguna.";
    }
  }
  ...
  // {
  //   // Mengecek jika metode permintaan adalah POST
  //   if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  //     // Panggil fungsi edit_user yang Anda buat sebelumnya
  //     edit_user($id);
  //   }

  //   // Panggil kembali view untuk menampilkan form edit
